        ...
        <form method="post" action="result.php">
          <table class="table">
            ...
            <tr>
                ...
                <td class="name2"><input type="text" name="usn" required class="box1"/></td>
            </tr>
            <tr>
                <th class="standered1">NAME</th>
                <td class="standered2"><input type="text" name="name" required class="box2"/></td>
            </tr> 
            <tr>
