    ...
    <header>
      ...
      <div class="main-content-header">
        ...
        <form method="post" enctype="multipart/form-data" action="secondstep.php">
            <table class="table1">
             <tr>
                <th>Name </th>   <th> Branch</th> <th>USN</th><th>Mobile No</th>
             </tr>
             <tr>
                 <td><input type='text' name='u_name' placeholder='Enter Full Name' required class="box"/></td>
                 <td><input type='text' name='u_branch' placeholder='Branch' required class="box"/></td>
                 <td><input type='text' name='id' placeholder='USN' required class="box"/></td>
             ...
             <!-- <table class="table2">
             <tr>
                <th>father Name </th>   <th> Mother Name</th> <th>Your City</th>
             </tr>
                 <tr>
